        ...
        <div className='flex flex-col min-h-screen'>
          ...
          <div className='flex flex-col w-full p-16 items-center justify-center bg-white'>
            ...
            <div className='flex flex-col items-center justify-center w-full md:flex-row'>
              ...
              <img className="flex w-full md:w-1/2 lg:w-1/3 lg:order-first" src={IMG2} />
            </div>
            <div className='flex flex-col items-center justify-center w-full md:flex-row'>
          ...
          <div className=' flex flex-col bg-black p-2 items-center justify-center lg:flex-row'>
            <div className='flex p-2 border-b-solid border-white'><p className='text-white hover:text-blue-500'>Copyright &copy; 2023 Freyada </p></div>
            <div className='flex flex-col items-center justify-center lg:flex-row '>
              <Link className='flex text-white hover:text-blue-500 p-1 lg:px-2 xl:px-4' to={"/termsAndConditions"}>Terms & Conditions</Link>
              <Link className='flex text-white hover:text-blue-500 p-1 lg:px-2 xl:px-4' to={"/userGuide"}>User Guide</Link>
              <Link className='flex text-white hover:text-blue-500 p-1 lg:px-2 xl:px-4' to={"/privacy"}>Privacy Policy</Link>
            </div>
          </div>
        </div>
      }</div>)}
